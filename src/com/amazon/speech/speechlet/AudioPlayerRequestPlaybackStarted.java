 ...
 *
 * @see Speechlet#onAudioPlayerRequest(AudioPlayerRequestPlaybackStarted, Session)
 */
@JsonTypeName("AudioPlayerRequest")
public class AudioPlayerRequestPlaybackStarted extends AudioPlayerRequest {
     ...
     */
    private AudioPlayerRequestPlaybackStarted(final Builder builder) {
     ...
     */
    protected AudioPlayerRequestPlaybackStarted(@JsonProperty("requestId") final String requestId,
