 ...
 *
 * @see Speechlet#onAudioPlayerRequest(AudioPlayerRequestPlaybackNearlyFinished, Session)
 */
@JsonTypeName("AudioPlayerRequest")
public class AudioPlayerRequestPlaybackNearlyFinished extends AudioPlayerRequest {
     ...
     */
    private AudioPlayerRequestPlaybackNearlyFinished(final Builder builder) {
     ...
     */
    protected AudioPlayerRequestPlaybackNearlyFinished(@JsonProperty("requestId") final String requestId,
    ...
    public static final class Builder {
        ...
        public AudioPlayerRequestPlaybackNearlyFinished build() {
            Validate.notBlank(requestId, "RequestId must be defined");
            Validate.notBlank(audioType, "type must be defined");
            return new AudioPlayerRequestPlaybackNearlyFinished(this);
        }
    }
}
